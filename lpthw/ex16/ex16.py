...
target.write(line1)# in first (target  ) get the (filename) (the function of open)////the second is the function is (write) it is who input the text in file 
target.write("\n")# the (write) function make the text in one line  for this you should use (\n) to jump line
target.write(line2) # is the same
target.write("\n") #is the same
target.write(line3)# is the same 
target.write("\n")#is the same
