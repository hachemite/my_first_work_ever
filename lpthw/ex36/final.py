...
def monster():
	...
	while True:
		...
		elif choice=="fight"or "kill" and sword==False:
		...
		elif choice=="fight"or "kill" and sword==True:
...
def bank():
    ...
    global money
    global debt
    print("""hello player this is the bank if you want get money
...
def merchant():
    ...
    while True:
        cho = input("You want buy something?\n")
        if cho== "no":
...
def library():
    ...
    while True:
        ...
        cho = input('What you need sir , I \' exited to anwser your question .\\\\\\\-->>>\t')
...
await to kill their victims if they do not pay the debt, so you should count yourself or return it quickly""")
        ...
        if cho=="school need help":
            ...
            input()
            print("So please help them, although they will try to show themselves that they are competent, so do not bother, there is financial reward")
        ...
        if cho =="what you need to mary":
            ...
            input()
            print("But whoever cares, I'm just a 60-year-old divorced woman running a book store T_T")
...
def school():
    ...
    ---------------------------------------------------------------------------------------------------
    -exercice3: solve equaution of second degree \ the chest is 2000G-------------------->\t(press'3')
    ...
    while True:
        ...
        if cho == '1':
            ...
            if t == l :
                ...
                dead('Idiot what are you doing here ,yu west my time')
...
def town():
    ...
    print("your money is ",money,"your debt is ",debt) 
    while True :
